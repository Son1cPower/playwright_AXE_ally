...
// @ts-ignore
import type {RunOptions, AxeResults, SerialContextObject, PartialResults, ContextObject, SerialSelectorList, SerialSelector, SerialFrameSelector} from 'axe-core';
