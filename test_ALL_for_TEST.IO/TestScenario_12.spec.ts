...
test.describe('Playwright web page accessibility test', async () => {
    ...
    test(`Settings > Notifications`, async () => {
        ...
        const skillsExperience = await page.locator("a[href='/testers/727140/notification_settings/edit']")
        await skillsExperience.click();


        url = await page.url()
        expect(url).to.equal('https://tester.test.io/testers/727140/notification_settings/edit')
